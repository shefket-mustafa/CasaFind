...
export default function Home() {
  return (
    <>
      ...
      <div className=" relative z-15  text-black h-25 font-bold px-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-center md:-mt-20 mb-20">
        <div className="flex flex-col items-center px-6 py-4  shadow-2xl  bg-white rounded-4xl ">
          ...
          <Link className="text-xl/30 text-gray-500">Learn More</Link>
        </div>
      ...
      <div className="h-screen w-full bg-white px-6 py-16">
      ...
      {/* Hero Section 3  */}
      <div className="bg-white h-screen px-16 py-12 flex flex-col md:flex-row items-center gap-10">
        {/* left Content */}
        <div className="w-full items-center md:w-1/2 text-left">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
    ...
    "
      ...
      <div className="flex flex-col justify-center items-center py-20 text-2xl  md:text-5xl h-screen w-full gap-20 bg-white">
        ...
        "
          ...
          <p className="text-2xl font-semibold text-gray-900">— Michael Phelps</p>

          <p className="text-xl md:text-2xl text-gray-800 ">
      “PLACE does four things really, really well. Number one, they lower your expenses. Number two,
      they take 80% of the tasks that you would normally do away so that you are focusing on working
      with buyers or sellers, which is what actually pays you in real estate. Number three, the
      opportunity model is huge. You can invest and diversify what you are doing outside of the next
      sale. And, number four, you get more time back.”
    </p>
          </div>
        </div>
      </div>
